"""
Django settings for movie_recommender project - Version Simple

Configuration simplifiée pour le système de recommandation de films.
"""
...
ROOT_URLCONF = 'movie_recommender.urls_simple'
...
# Database configuration with djongo for MongoDB
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
...
MONGODB_URI = config('MONGODB_URI', default='mongodb://localhost:27017/movie_recommendation')
...
# Neo4j Settings dict for compatibility
NEO4J_SETTINGS = {
    'uri': NEO4J_URI,
